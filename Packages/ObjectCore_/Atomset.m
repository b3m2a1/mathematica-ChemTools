...
parseToAtoms[system_,{{a_,b_},o__}]:=
	With[{atoms=
			CreateAtom[system, Map[{First@#,"Position"->Last@#}&,{o}[[;;a]]] ]
			},
		Do[
			AtomCreateBond[
				atoms[[ First@bond ]],
...
CreateAtomset[
	sys:chemSys|Automatic:Automatic,
	atoms:chemObjV|{},
...
CreateAtomset[sys:chemSys|Automatic:Automatic,
	atoms:chemObj...,
		...
		{{_String,
			{
				...
				_?NumericQ|_Quantity,
				_?NumericQ|_Quantity}|_QuantityArray
				},___List},
	o:chemOptionsPattern]:=
	With[{atSpec=
		If[MatchQ[First@atoms,{_Integer,_Integer}],
			atoms,
			Prepend[atoms,
				{
...
CreateAtomset[
	sys:chemSys|Automatic:Automatic,
	atoms:{{_String},{_,_},___},
	o:chemOptionsPattern]:=
	CreateAtomset[sys,ChemUtilsGenerateMolTable[atoms],o];
...
AtomsetGetAtoms[obj:chemObj,test_]:=
	Replace[test,{
		Identity|All|
...
AtomsetAddAtom[obj:chemObj,atoms:chemObjAll]:=(
...
AtomsetRemoveAtom[obj:chemObj,atoms:chemObjAll]:=(
...
AtomsetJoin[objV:chemObjV]:=
	CreateAtomset@Flatten@ChemGet[objV,"Atoms"];
AtomsetJoin[objV:chemObj..]
...
AtomsetEmpiricalFormula[obj:chemObj]:=
	With[{els=
		ChemDataLookup[
...
AtomsetElementPositions[obj:chemObj]:=
...
AtomsetBondsIndexed[obj:chemObj]:=
	With[{a=ChemGet[obj,"Atoms"]},
...
AtomsetBondVectors[obj:chemObj]:=
	With[{a=ChemGet[obj,"Atoms"]},
		With[{
			b=DeleteDuplicates@Flatten@ChemGet[a,"Bonds"],
...
AtomsetBondLengths[obj:chemObj]:=
	Norm/@AtomsetBondVectors[obj]


AtomsetMeanBondLengths[obj:chemObj,extras_:None]:=
	Mean@*Map[Last]/@
		With[{
			bm=AtomsetBonds@obj,
			a=ChemGet[obj,"Atoms"]
...
AtomsetNeighborMap[obj:chemObj]:=
	With[{
...
AtomsetNormalizeBonds[
	obj:chemObj,
	bondSel:chemObj|chemObjV|All:All,
	ops:OptionsPattern[]
	]:=
	Catch@
	Module[
...
AtomsetAdjacencyMatrix[obj:chemObj]:=
	ReplacePart[
...
AtomsetGraph[obj:chemObj,style:True|False:False]:=
...
AtomsetGraphEvents[obj:chemObj,
...
AtomsetConnectedComponents[obj:chemObj]:=
...
AtomsetConjugatedSystems[obj:chemObj]:=
	With[{atoms=ChemGet[obj,"Atoms"]},
...
AtomsetAromaticRings[obj:chemObj]:=
	With[{
		rs=AtomsetRings[obj],
...
AtomsetAtomMemberQ[obj:chemObj,ov:chemObjV,"Ring"]:=
...
AtomsetAtomMemberQ[obj:chemObj,ov:chemObjV,"ConjugatedSystem"]:=
...
AtomsetAtomMemberQ[obj:chemObj,ov:chemObjV,"AromaticRing"]:=
...
AtomsetAtomMemberQ[obj:chemObj,ov:chemObjV,
...
AtomsetAtomMemberQ[obj:chemObj,type_String]:=
	AtomsetAtomMemberQ[obj,ChemGet[obj,"Atoms"],type];
AtomsetAtomMemberQ[obj:chemObj,ov:chemObj..,type_String]:=
...
AtomsetCenter[obj:chemObj]:=
	Mean@ChemGet[
		ChemGet[obj,"Atoms"],
		"Position"];


AtomsetCenterOfMass[obj:chemObj]:=
	With[{a=ChemGet[obj,"Atoms"]},
		WeightedData[
			ChemGet[a,"Position"],
			ChemGet[a,"Mass"]
...
AtomsetMove[
	obj:chemObj,
	at:chemObj?(ChemInstanceQ["Atom"])->{x_,y_,z_},
	Optional["Set","Set"]
	]:=
	With[{inc=
...
AtomsetAlignmentTransform[
	obj:chemObj,
	b:chemObj?(ChemInstanceQ["Atomset"])
	]:=
	ChemUtilsAlignmentTransform[
		AtomsetMassPositions[obj]->
...
AtomsetVdWSurface[obj:chemObj,ops:OptionsPattern[]]:=
	With[{atoms=ChemGet[obj,"Atoms"]},
		With[{
...
AtomsetVdWVolume[obj:chemObj]:=
	Quantity[Volume@AtomsetVdWSurface[obj],"Angstroms"^3];


atomsetGastInitialCharges[obj:chemObj]:=
	With[{
...
atomsetGastAssign[obj:chemObj,log:True|False:False]:=
	Block[{
...
AtomsetPartialCharges/:
	Unset[AtomsetPartialCharges[obj:_?(MatchQ[chemObj])]]:=
		With[{g=ChemGet[obj,"Atoms"]},
			AtomPartialCharge[g]=.
			];
AtomsetPartialCharges/:
	Set[AtomsetPartialCharges[obj:_?(MatchQ[chemObj])],v_List]:=
		With[{g=ChemGet[obj,"Atoms"]},
...
AtomsetPartialCharges/:
	SetDelayed[AtomsetPartialCharges[obj:_?(MatchQ[chemObj])],v_List]:=
		With[{g=ChemGet[obj,"Atoms"]},
...
AtomsetPartialCharges/:
	SetDelayed[AtomsetPartialCharges[obj:_?(MatchQ[chemObj])],v_]:=
		With[{g=ChemGet[obj,"Atoms"]},
			AtomPartialCharge[g]:=v
			]
...
AtomsetPsi4Scan[
	obj:chemObj,
	specs:{(chemObj\[Rule](_List|_Integer))..},
	ops:OptionsPattern[]]:=
	Psi4ConfigureCall
...
Options[AtomsetEnergy]=
	Options[Psi4Energy];
AtomsetEnergy[obj:chemObj,ops:OptionsPattern[]]:=
	$Psi4@
		Psi4Energy[
			AtomsetElementPositions@obj,
			ops
...
AtomsetGraphic[obj:chemObj,ops:OptionsPattern[]]:=
...
Options[AtomsetGraphic3D]=
	Normal@Merge[{
		...
		Last];
AtomsetGraphic3D[obj:chemObj,ops:OptionsPattern[]]:=
	With[{a=DeleteDuplicates@ChemGet[obj,"Atoms"]},
		With[{b=
			Pick[#,
				Map[
				...
				},
			{
				If[Length@a>0,
					AtomGraphic3D[a,
						FilterRules[{ops},Options@AtomGraphic3D]],
					Nothing
					],
				If[Length@b>0,
					BondGraphic3D[b,
