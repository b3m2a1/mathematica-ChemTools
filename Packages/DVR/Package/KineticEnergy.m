...
(* ::Text:: *)
(*
	To avoid Compile overhead and compilation to C we\[CloseCurlyQuote]re gonna just use the basic Kronecker sum.
	Might return to the Compiled one later if needed, though.
*)



kroneckerSum[m1_, m2_]:=
  KroneckerProduct[IdentityMatrix[Length@m2, SparseArray], m1]+
    KroneckerProduct[m2, IdentityMatrix[Length@m1, SparseArray]]
