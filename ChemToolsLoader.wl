...
Temp`PackageScope`ChemToolsLoading`Private`$DependencyLoad=
  TrueQ@Temp`PackageScope`ChemToolsLoading`Private`$DependencyLoad;
If[Temp`PackageScope`ChemToolsLoading`Private`$DependencyLoad,
  Unprotect["`ChemTools`PackageScope`Private`Constants`$TopLevelLoad"];
  Evaluate[Symbol["`ChemTools`PackageScope`Private`Constants`$TopLevelLoad"]]=False,
  Unprotect["ChemTools`PackageScope`Private`Constants`$TopLevelLoad"];
  Evaluate[Symbol["ChemTools`PackageScope`Private`Constants`$TopLevelLoad"]]=
    MemberQ[$ContextPath, "Global`"]
  ];


If[Temp`PackageScope`ChemToolsLoading`Private`$DependencyLoad,
  Evaluate[Symbol["`ChemTools`PackageScope`Private`$RootContext"]]=$Context;
  BeginPackage["`ChemTools`"],
  Evaluate[Symbol["ChemTools`PackageScope`Private`$RootContext"]]="";
  BeginPackage["ChemTools`"]
  ]


ClearAll[ChemTools];
ChemTools::usage="ChemTools is a manager head for the ChemTools package";
...
ChemTools["Mode"]:=$PackageLoadingMode
$PackageLoadingMode=
...
ChemTools["Dependencies"]:=$PackageDependencies;
$PackageDependencies=
...
ChemTools["DependencyBase"]:=$PackageDependencyBase;
...
PackagePrepPackageSymbol[]:=
  Switch[$AllowPackageSymbolDefinitions,
    None,
      If[Length@OwnValues[ChemTools]==0,
        Remove[ChemTools],
        DownValues[ChemTools]={}
        ],
    False,
...
Remove["Temp`PackageScope`ChemToolsLoading`Private`*"]